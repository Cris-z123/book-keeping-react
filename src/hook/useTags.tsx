...
const useTags = () => {
  const [tags, setTags] = useState<
    { id: number; name: string; billType: "IN" | "OUT"; iconName: string }[]
  >([]);
  useEffect(() => {
    ...
    if (localTags.length === 0) {
      localTags = [
        ...
        },
        {
          ...
          name: "日用百货",
          billType: "OUT",
          iconName: "daily-necessities",
        },
        {
          id: createId(),
          name: "家居家装",
          billType: "OUT",
          iconName: "furnishings",
        },
        {
          id: createId(),
          name: "数码电器",
        ...
        { id: createId(), name: "工资收入", billType: "IN", iconName: "wages" },
